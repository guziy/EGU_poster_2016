...
\veryHuge \color{NavyBlue} \textbf{Lake-river and lake-atmosphere interactions in a changing climate over Northeast Canada} \color{Black}\\ % Title
\Huge\textit{ }\\[1cm] % Subtitle
\huge \textbf{Oleksandr Huziy \& Laxmi Sushama}\\ % Author(s)
\huge University  of Quebec in Montreal (UQÀM)\\ % University/organization
Email: \texttt{guziy.sasha@gmail.com} \\ % Email address
\end{minipage}
%
...
maximum decreases of the order of 2C occurring during winter. As for streamflows, results suggest projected
