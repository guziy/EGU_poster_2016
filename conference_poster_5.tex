...
\begin{minipage}{\linewidth}
  ...
  \begin{tikzpicture}
      % schematics
      \node[label={\small ERAI-CRCM5-L1 minus ERAI-CRCM5-NL}] (la) at (0,0) {\includegraphics[scale=0.5]{lake-atm-interactions}};
      \node[label={\small ERAI-CRCM5-L minus ERAI-CRCM5-L1}] (lr) at (20,0) {\includegraphics[scale=0.5]{lake-river-interactions}};
  \end{tikzpicture}
\end{minipage}
