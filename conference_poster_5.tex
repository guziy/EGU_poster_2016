...
\begin{minipage}{\linewidth}
  ...
  \begin{tikzpicture}
      ...
      \node[label={\textbf{(a)} \small ERAI-CRCM5-L1 minus ERAI-CRCM5-NL}] (la) at (-9,0) {
        \adjincludegraphics[trim={{0.125\width} {0.35\height} {0.105\width} {0.5\height}}, clip]{STFA_CRCM5-L1_CRCM5-NL}};
      \node[label={\textbf{(b)} \small ERAI-CRCM5-L minus ERAI-CRCM5-L1}] (lr) at (9,0) {
        \adjincludegraphics[trim={{0.125\width} {0.35\height} {0.105\width} {0.5\height}}, clip]{STFA_CRCM5-L2_CRCM5-L1}};
  \end{tikzpicture}
  \captionof{figure}{\label{fig_la_and_lr}\color{Green} Impacts of lake-atm. interactions (left) and impacts of lake-river interactions (right). Not significant impacts are shown in gray.}
\end{minipage}
