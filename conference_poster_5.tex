...
\begin{minipage}[b]{0.45\linewidth}
\begin{center}
  \includegraphics[width=\linewidth]{streamflow_validation}
  \captionof{figure}{\color{Green} Improvements to the simulated streamflow due to the inclusion of the lake-river interactions. Observed streamflow is taken from CEHQ.}
\end{center}
\end{minipage}\hfill
%
\begin{minipage}[b]{0.45\linewidth}
